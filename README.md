...
이 브릿지 서버를 통해 저희 백엔드 장고에서 

증권사 api를 Windows가 아닌 환경에서 공인인증서없이 이용할 수 있도록 하였습니다. 

저희는 이를 바탕으로 장고에서 현재 상장되어있는 모든 주식과 ETF의 20년간의 일봉데이터, 

약 828만개를 전달받아 DB에 모두 저장하였습니다. 

저희는 이를 바탕으로 시뮬레이션을 제공하기 위해 

리밸런싱 기능을 제공하고자 했고 포트폴리오 이론에 따른 알고리즘을 구현하였습니다. 
