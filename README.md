...
저희가 구현한 리밸런싱은 앞서 말씀드렸다시피 

인베스팅의 포트폴리오 이론에 기반한 알고리즘이라고 할 수 있습니다. 

좀더 자세히 설명드리자면, 

여러가지 종목에 정해진 비율로 자산을 분산 투자하고, 

일정 주기마다 다시 비율을 조정해 줌으로서,

자산의 비중이 늘어난, 즉 가치가 높아진 종목에서 자산을 일부 처분하여

자산의 비중이 줄어든, 즉 가치가 낮아진 종목에 다시 자산을 배분하는 것입니다. 

저희는 이 정해진 비율과 종목에 따라 과거에 자산을 투자하고 리밸런싱 했을 경우의

수익률을 백테스팅 시뮬레이션해서 시각화하여 보여드리고,

![graph](/readme/graph.png)

사용자가 어떤 투자전략이 유효할지 어림짐작하여 

포트폴리오를 개선할 수 있도록 도와주는 서비스를 만들었습니다. 
