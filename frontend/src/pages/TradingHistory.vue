...
const tableColumns = ["일시", "종목", "거래종류", "거래수량", "거래금액"];
const tableData = [
  {
    id: 1,
    일시: "2020-05-20 10:13:23",
    종목: "SK하이닉스",
    거래종류: "매수",
    거래수량: "46",
    거래금액: "10000000"
